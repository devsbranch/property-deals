...
def index():
    ...
    return render_template('index.html', segment='index', properties=properties, photos=photos)
...
def create_property():
    ...
    if form.validate_on_submit():
        ...
        prop_info = Property(name=form.prop_name.data,
        ...
        return redirect(url_for('home_blueprint.view_property'))
...
def view_property():
    ...
    return render_template('properties.html', properties=properties, photos=photos,
...
def details(property_id):
    ...
    return render_template('property_details.html', prop_data=prop_data, photos=photos)
...
def account():
    ...
    property_by_user = Property.query.filter_by(user_id=current_user.id).order_by(Property.date.desc())
...
def delete_property(property_id):
    ...
    image_dir = os.path.join(f"{current_app.root_path}/base/static/{prop_to_delete.image_folder}")
